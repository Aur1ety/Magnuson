...
<div class="login-pf-page">
    ...
    <div id="kc-form">
      <div id="kc-form-wrapper">
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="https://idp.issdc.gov.in/auth/realms/issdc/login-actions/authenticate?session_code=toroiZMuDQAgK_nhSnlNjuPyEJuYZ3ilsK-tP9dRaMM&amp;execution=4f75202b-ce79-477f-83e4-f05fbc4f5eb6&amp;client_id=al1-pradan&amp;tab_id=ZHSCal9RJeE" method="post">
                ...
                <div class="form-group login-pf-settings">
                    <div id="kc-form-options">
                        ...
                        <div class="">
                                <span><a tabindex="5" href="/auth/realms/issdc/login-actions/reset-credentials?client_id=al1-pradan&amp;tab_id=ZHSCal9RJeE">Forgot Password?</a></span>
                        </div>
            ...
            <div id="kc-registration-container">
                <div id="kc-registration">
                    <span>New user? <a tabindex="6"
                                                 href="/auth/realms/issdc/login-actions/registration?client_id=al1-pradan&amp;tab_id=ZHSCal9RJeE">Register</a></span>
                </div>
            </div>
